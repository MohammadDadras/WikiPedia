...
import com.example.wikipedia.fragment.SEND_DATA_SECOND_ACTIVITY
...
class MainActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
     ...
     supportActionBar!!.setHomeButtonEnabled(true)
      supportActionBar!!.setDisplayHomeAsUpEnabled(true)
        ...
        val dataPost = intent.getParcelableExtra<ItemPost>(SEND_DATA_SECOND_ACTIVITY)
    ...
    private fun showData(itemPost: ItemPost) {
        ...
        binding.txtDetailSubtitle.text = itemPost.txtSubtitile
        binding.txtDetailText.text = itemPost.txtDetail

        binding.fabDetailMain.setOnClickListener {
